...
export default function index() {
  ...
  return (
    <section className="min-h-screen w-full h-full">
      <div className="box">
        <h2 className="uppercase lg:text-[150px] font-semibold">about</h2>
        <p
          ref={description1}
          className="lg:text-[30px] leading-[150%] font-medium"
        >
      ...
      <div className="second-box">
        <h2 className="lg:uppercase lg:text-[80px] font-semibold">
          our process
        </h2>
        <p
          ref={description2}
