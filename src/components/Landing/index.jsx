  ...
  return (
    <main className="min-h-screen overflow-hidden relative" id="#home">
      ...
      <h1 className="heading">
        PLANN<span className="text-[#0000A3] font-bold italic o-class">O</span>
        RIUM
      </h1>
      ...
      <div className="pic absolute top-[15%] sm:top-[20%] md:top-[21%] lg:top-[35%] w-full h-[200px] md:w-[725px] md:h-[330px] lg:w-[47vw] lg:h-[23vw] bg-[#0000a3]">
        <div className="w-full h-full flex items-center justify-center">
          <Image
            ...
            height={0}
            alt="image"
            className="w-[350px] md:w-[579px] lg:w-[40vw]"
          />
        </div>
        <p className="2xl:text-[30px] text-[25px]">
          Pioneering Digital Excellence
        </p>
      </div>

      <div className="text-landing absolute left-2 lg:left-[57%] top-[55%] sm:top-[65%] md:top-[75%] lg:top-[40%]">
        <p className="text-[20px] lg:text-[23px] xl:text-[30px] text max-w-[330px] lg:max-w-145 font-normal">
        ...
        <div className="flex absolute top-[125%] xl:top-[120%] gap-8 sm:gap-10 z-50">
          <Magnetic>
            <button
              className="button button-full font-normal"
              onClick={(e) => {
                e.preventDefault();
                const work = document.querySelector("#work");
                if (work) {
                  const y =
                    work.getBoundingClientRect().top + window.pageYOffset;
          ...
          <button
            className="button button-hover font-normal"
            onClick={(e) => {
              e.preventDefault();
